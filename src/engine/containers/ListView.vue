...
<template>
  <div class="list-view" :class="{ 'is-mobile': isMobile }">
    ...
    <SchemaTable ref="schemaTableRef" :schema="schema" :rows="recordStore.records" :view-config="viewConfig || []"
      ...
      :height="tableHeight" :density="density" :appearance="appearance" :readonly="readonly"
      :row-number-start="(currentPage - 1) * pageSize" @sort-change="handleSortChange" @filter-change="handleHeaderFilterChange"
